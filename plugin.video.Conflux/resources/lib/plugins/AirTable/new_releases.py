"""
    new_releases.py --- writes a local New releases xml
    ...
    <dir>
    <title>Update New Releases</title>
    <link>plugin://plugin.video."---YOUR ADDON---"/?mode=RunScript&url=special://home/addons/plugin.video."---YOUR ADDON---"/resources/lib/plugins/AirTable/new_releases.py</link>
    <summary>Updates the New Releases xml</summary>
    </dir>
    ...
    <link>file://new_releases.xml</link>
    <summary></summary>
    </dir>

    The new_releases.xml that is generated is located in the kodi/addons/plugin.video."YOUR ADDON"/xml folder
...
xml_file = xbmc.translatePath('special://home/addons/'+AddonName+'/xml/new_releases.xml')

open(xml_file,'w')

def Pull_info():
    try:
        at = Airtable('appTkr2yvgd1LTyD6', 'New_Releases', api_key='keyOHaxsTGzHU9EEh')
