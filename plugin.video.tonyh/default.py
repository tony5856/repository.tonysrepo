...
ADDON=xbmcaddon.Addon(id='plugin.video.tonyh')
...
def CATEGORIES():
    link = OPEN_URL('http://tonyh.net/wizard.html').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("[COLOR=orange]Tonyh Wizard[/COLOR]","[COLOR=orange]DOWNLOADING[/COLOR]",'', '[COLOR=orange]Please Wait[/COLOR]')
